...
if TychEquis(1) == 0
    ...
    for nNet = 1:NNets
        ...
        GWinWfb = (pinv(args * args' / learnLength + ...
        ...
        F{nNet} = (pinv(args * args' / learnLength + ...
...
for nNet = 1:NNets
    ...
    targs = pCollector;
    WoutAll{nNet} = (pinv(args * args' / learnLength + ...
    ...
    args = zCollector{nNet};
    targs = predCollector;
    Wpred{nNet} = (pinv(args * args' / learnLength + ...
